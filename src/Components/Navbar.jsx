        ...
        <div className="flex items-center gap-4">
                ...
                <defs>
                  <clipPath id="clip0_1_7">
                    <rect
                      ...
                      height="14.7"
                      fill="white"
                      transform="translate(0.0750122 0.762573)"
                    />
                  </clipPath>
                </defs>
              </svg>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-400">
              {user ? user.fullName || "User" : "loading..."}
            </span>
          </div>
        </div>
      </nav>
