...
const properties = [
  ...
  function PropertyCard({property}){
    return ( 
        <div className="bg-white rounded-lg cursor-pointer hover:scale-110 transition ease-in-out overflow-hidden shadow-sm">
...
const Discover = () => {
  ...
  return (
    <div className='max-w-7xl ml-24 mx-auto px-4 py-8'>
         <h1 className='text-xl font-semibold mb-6'>Discover popular properties</h1>
