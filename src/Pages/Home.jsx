 ...
 * Dashboard Component
 *
 * This React component displays an NFT marketplace dashboard with the following sections:
 * - NFT Marketplace: Displays featured NFT properties.
 * - Investment Stats: Shows total investment, weekly returns, and expenses.
 * - My Cards: Displays user balance and monthly profit.
 * - NFTs Owned: Lists NFTs owned by the user along with value and change.
 * - Total Distributions: A line chart showing distribution trends.
 * - Top Picks: Displays top recommended properties.
 *
 * Technologies Used:
 * - React for UI components
 * - Tailwind CSS for styling
 * - Recharts for the line chart visualization
 * */
...
const investmentStats = [
  { name: 'totalInvestment', value: 80 },
  { name: 'weeklyReturns', value: 100 },
...
const Home = () => {
  ...
  return (
    <div
      className={`ml-20 flex gap-2 bg-${
        theme === 'light' ? '[rgba(250,250,254)]' : theme
      }`}
    >
      <div className='main max-w-5xl '>
        <div className='main-1 flex justify-between'>
          {/* NFT MARKETPLACE*/}
          <div
            className={`bg-${
              theme === 'dark' ? '[#373739]' : ''
            } w-[50%] p-6 rounded-2xl hover:cursor-pointer`}
          >
            ...
            <div className='relative duration-300 ease-in-out transition hover:scale-110 rounded-xl overflow-hidden'>
              ...
              <div className='absolute top-4 left-4 flex gap-2'>
                <button
                  className={`px-3 py-1 bg-white/80 rounded-full text-black hover:bg-white/90 cursor-pointer text-sm`}
                >
                  Top picks
                </button>
                <button
          ...
          <div className='w-[50%] flex '>
            <div
              className={`bg-${
                theme === 'dark' ? '[#373739]' : ''
              } w-[50%] p-6 rounded-2xl`}
            >
              <h2 className='text-lg font-semibold mb-6'>Investment Stats</h2>
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex gap-2'>
                    ...
                    <div className=''>
                      ...
                      <p className='text-[rgba(251,177,66,1)] font-semibold flex items-center gap-2'>
                        <svg
                          width='21'
                          height='21'
                          viewBox='0 0 14 14'
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex gap-2'>
                    ...
                    <div className='text-[rgba(79,223,177,1)] '>
                      <p className='text-gray-500 text-sm'>Weekly Returns</p>
                      <p className='text-[rgba(79,223,177,1)]] font-semibold flex items-center gap-2'>
                        <svg
                          width='21'
                          height='21'
                          viewBox='0 0 14 14'
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex gap-2'>
                    ...
                    <div className=''>
                      ...
                      <p className='font-semibold text-[rgba(237,91,117,1)] flex items-center gap-2'>
                        <svg
                          width='21'
                          height='21'
                          viewBox='0 0 14 15'
            ...
            <div
              className={`w-[25%]   p-6 bg-${
                theme === 'dark' ? '[#373739]' : ''
              }`}
            >
              <ResponsiveContainer width='100%' height='100%'>
                <BarChart data={investmentStats}>
                  <Bar
                    dataKey='value'
                    radius={[10, 10, 10, 10]}
                    fill='#ED5B75'
            ...
            <div className='relative text-gray-300'>
              <h2 className='absolute top-1.5 right-1.5'>Max </h2>
              <h2 className='absolute bottom-6 right-0.5'>Min</h2>
            </div>
          </div>
        </div>
          ...
          <div className='grid grid-cols-3 gap-6'>
            ...
            >
              <div className='flex justify-between items-center mb-6'>
                <h2 className='text-lg font-semibold'>NFTs owned</h2>
            ...
            >
              <div className='flex justify-between items-center mb-6'>
                <h2 className='text-lg font-semibold'>Total Distributions</h2>
                <div className='flex gap-2'>
                  <button
                  ...
                  <button className='p-1 rounded-lg bg-purple-100 text-purple-600'>
      ...
      <div
        className={`cards px-10 py-6  bg-${
          theme === 'dark' ? '[#373739]' : ''
        } h-screen `}
      >
        <h2 className='mb-4 font-medium'>My Cards</h2>
        ...
        <div className=''>
          <div className={`bg-${theme === 'dark' ? '[#373739]' : ''} p-6`}>
            <div className='flex justify-between items-center mb-6'>
              ...
              {topPicks.map((pick, index) => (
                ...
                >
                  ...
                  <div className='flex items-center gap-4'>
                    <p className='text-sm text-gray-500'>{pick.eth}</p>
                    <button className='text-gray-400'>&gt;</button>
                  </div>
                </div>
              ))}
