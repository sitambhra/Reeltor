...
const Home = () => {
  return (
    <div className="ml-20 flex gap-2 bg-[rgba(250,250,254)]">
      <div className="main max-w-5xl ">
        <div className="main-1 flex justify-between">
          {/* NFT MARKETPLACE*/}
          <div className="bg-white w-[50%] p-6 rounded-2xl hover:cursor-pointer">
          ...
          <div className="w-[50%] flex ">
            <div className="bg-white w-[50%] p-6 rounded-2xl">
                ...
                {nftsOwned.map((nft, index) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-lg text-black font-bold flex items-center gap-1">
                        <span className="">
                          <svg
                            width="21"
                            height="21"
      ...
      <div className="cards px-10 py-6  bg-white h-screen ">
